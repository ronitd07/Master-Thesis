...
"""
heat pump model of MVV GKM Manheim using charline char for compressors
...
class Heatpump_tespy():
    ...
    def setup_heat_pump(self):
        ...
        line1 = load_custom_char('line_eta1', CharLine)
        ...
        line2 = load_custom_char('line_eta2', CharLine)
