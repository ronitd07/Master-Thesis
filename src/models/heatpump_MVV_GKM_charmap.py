...
class Heatpump_tespy():
    ...
    def calc_partload_state(self, sink_temp_in:float=None,sink_temp_out:float=None, source_temp_in:float=None, source_temp_out:float=None, Q:float=None,
                            ...
                            igva1:float=None,igva2:float=None,eta1:float=None,eta2:float=None,cp1_real:float=None,cp2_real:float=None,k1:float=None,k2:float=None)-> tuple[float, float, float, float, float, float, float, float, float, float, float]:
        ...
        igva1 : float, optional
            inlet guide vane angle of compressor 1, by default None
        igva2 : float, optional
            inlet guide vane angle of compressor 2, by default None
        eta1 : float, optional
            Compressor 1 isentropic efficiency, by default None
        eta2 : float, optional
            Compressor 2 isentropic efficiency, by default None
        cp1_real : float, optional
            Compressor 1 power, by default None
        cp2_real : float, optional
            Compressor 2 power, by default None
        k1 : float, optional
            Compressor 1 efficiency scaling factor, by default None
        k2 : float, optional
            Compressor 2 efficiency scaling factor, by default None
        ...
        cp1 : float
            Compressor power of compressor 1.

        cp2 : float
            Compressor power of compressor 2.
