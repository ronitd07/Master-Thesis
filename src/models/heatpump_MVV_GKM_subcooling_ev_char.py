...
class Heatpump_tespy():
    ...
    def calc_partload_state(self, sink_temp_in:float=None,sink_temp_out:float=None, source_temp_in:float=None, source_temp_out:float=None, Q:float=None,
        ...
        self.ev.set_attr(ttd_l=None, offdesign = ['kA_char1'])
        ...
        try:
            print(f'variables before presolve : {self.nwk.get_variables_before_presolve()}')
            print(self.nwk.get_presolved_variables())
            print(self.nwk.get_equations())
            print(self.nwk.get_equations_with_dependents())
            print(self.nwk.get_variables())
            self.nwk.solve_determination()
