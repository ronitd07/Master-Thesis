...
from heatpump_MVV_GKM_charmap_copy import Heatpump_tespy
...
def simulation_loop():
    ...
    for step in tqdm(range(0,n_steps,10), desc="Calculation"):
        ...
        try:
            ...
            eta1,eta2,m1,m2,X,x,cop,cp1,cp2,igva1,igva2 = heatpump_model.calc_partload_state(sink_temp_in,sink_temp_out, source_temp_in,source_temp_out,Q_load,p_inter,t_evap,t_cond,sp_comp1,p_cond,t_subcooler,cp1_real,cp2_real)
