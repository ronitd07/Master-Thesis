...
"""
heat pump model of MVV GKM Manheim with Polynomial Compressor
...
class Heatpump_tespy():
    ...
    def setup_heat_pump(self):
        ...
        self.cp1 = PolynomialCompressor("compressor1")
        self.cp2 = PolynomialCompressor("compressor2")
        ...
        y=[0.373059 ,  0.62864322, 0.79268357 ,0.88967366, 0.94410716] # isentropic efficiency
        )
        ...
        y=[0.48490718 ,0.63255384 ,0.7194824 , 0.76619529 ,0.79319494]# isentropic efficiency
        )
        # saves the char line plot
        line2.plot(
                path="charline.png",
    ...
    def calc_partload_state(self, sink_temp_in:float=None,sink_temp_out:float=None, source_temp_in:float=None, source_temp_out:float=None, Q:float=None,
        ...
        try:
            ...
            T_delta = None
            m_flow = 0
        return cop, cp1,cp2,load,T_delta,ft_x,T_evap,T_cond,
