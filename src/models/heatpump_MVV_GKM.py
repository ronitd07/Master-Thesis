...
class Heatpump_tespy():
    ...
    def setup_heat_pump(self):
        ...
        self.c8 = Connection(self.va2, "out1", self.ev, "in1", label="8")
        self.c9 = Connection(self.dum, "out1", self.sp, "in2", label="9")



        self.nwk.add_conns(self.c0, self.c1, self.c2,self.c2a, self.c3, self.c4, self.c5, self.c6, self.c7, self.c8,self.c9)
        ...
        #self.c7.set_attr(x=0.0)  # saturated liquid
        #self.c6.set_attr(x=1.0)   # saturated vapor
        self.va1.set_attr(pr=0.33)
        self.c4.set_attr(m=0.6)
        self.c4.set_attr(td_bubble = 2)

        self.c9.set_attr(m=0,p=1)
