...
class Heatpump_tespy():
    ...
    def setup_heat_pump(self):
        ...
        #Custom charmaps
        self.cp1.set_attr(eta_s=self.eta_compressor1, design = ['eta_s'],char_map_eta_s = {'char_func' : map_eta1},char_map_pr = {'char_func' : map_pr1}, offdesign = ['char_map_pr'])
        self.cp2.set_attr(eta_s=self.eta_compressor2, design = ['eta_s'],char_map_eta_s = {'char_func' : map_eta2},char_map_pr = {'char_func' : map_pr2}, offdesign = ['char_map_pr'])
    ...
    def calc_partload_state(self, sink_temp_in:float=None,sink_temp_out:float=None, source_temp_in:float=None, source_temp_out:float=None, Q:float=None,
        ...
        self.cp1.set_attr(igva='var',P=cp1_real*1e3)
        self.cp2.set_attr(igva='var',P=cp2_real*1e3)
