'''
Plot characteristic eta pr char maps without considering igva manipulation
'''
...
def eta1_map():
    ...
    x_values_to_plot = [0.958,0.9595,0.9666, 0.9912, 0.9913, 0.9914, 0.9915, 0.9916, 0.9927, 0.9928, 0.9929, 0.993]
...
def eta2_map():
    ...
    x = df['Speed line x'].round(4)
    y = (df['Comp2 m'].to_numpy() * p2_design) /(m2_design * df1['Column19'] * x )
    ...
    x_values_to_plot = [0.9902,0.9921,0.9923,1.0023,1.0033,1.0038,1.0040,1.0043,1.0046,1.0047]
