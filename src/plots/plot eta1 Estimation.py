...
R2 = r2_score(df1_10['Column46'], df2['eta1'])
print("R^2 =", R2)

#Determine standard deviation sigma
error_abs = np.abs(df1_10['Column46'].values - df2['eta1'].values)
...
ax.plot(df1_10['Column46'], df2['eta1'], 'o',label = f'$R^2$ = {R2:.3f}, $\\sigma$ = {std_error:.3f}')
ax.plot(x,y)
